...
provide the following information:
 ...
 - Which version of bitzec Wallet are you using? (Check bitzec Wallet version on the side menu)
 ...
 - Please check bitzec Wallet logs (General Settings -> About bitzec Wallet -> Session Logs). Look for
...
Please adhere to the coding conventions used throughout bitzec Wallet (indentation, tests, etc.)
