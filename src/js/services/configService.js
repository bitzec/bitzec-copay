  ...
  var defaultConfig = {
    ...
    rateApp: {
      ...
      copay: {
        ...
        android: 'https://play.google.com/store/apps/details?id=com.bzccom.bzc-wallet',
        wp: ''
      }
    },
    ...
    release: {
      url: 'https://api.github.com/repos/bitzec/bitzec-copay/releases/latest'
    },
    ...
    storageService.getConfig(function(err, localConfig) {
      if (localConfig) {
        ...
        if (configCache.wallet.settings.unitCode == 'bit') {
          // Convert to BZC. Bits will be disabled
