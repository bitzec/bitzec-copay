...
angular.module('copayApp.services').factory('addressbookService', function($log, bitcoreBzc, storageService, lodash) {
  var root = {};

  var getNetwork = function(address) {
    var network;
    network = (new bitcoreBzc.Address(address)).network.name;
    return network;
  };
