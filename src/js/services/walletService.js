...
angular.module('copayApp.services').factory('walletService', function($log, $timeout, lodash, trezor, ledger, intelTEE, storageService, configService, rateService, uxLanguage, $filter, gettextCatalog, bwcError, $ionicPopup, fingerprintService, ongoingProcess, gettext, $rootScope, txFormatService, $ionicModal, $state, bwcService, bitcoreBzc, popupService) {
  ...
  // https://github.com/bitpay/bitcore-wallet-service-bzc/blob/master/lib/model/txproposal.js#L243
  ...
  root.copyCopayers = function(wallet, newWallet, cb) {
    ...
    var walletPrivKey = bitcoreBZC.PrivateKey.fromString(c.walletPrivKey);
